...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/generateur-mot-de-passe`,                              lastModified: now, changeFrequency: 'monthly',  priority: 0.9 },
    { url: `${base}/a-propos`,                                             lastModified: now, changeFrequency: 'monthly',  priority: 0.8 },
    { url: `${base}/blog`,                                                 lastModified: now, changeFrequency: 'weekly',   priority: 0.7 },
    { url: `${base}/blog/gestionnaire-mots-de-passe-gratuit-2026`,         lastModified: now, changeFrequency: 'monthly',  priority: 0.8 },
    { url: `${base}/blog/double-authentification-2fa`,                     lastModified: now, changeFrequency: 'monthly',  priority: 0.8 },
