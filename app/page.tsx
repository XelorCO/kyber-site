...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0e1015] text-stone-100 overflow-x-hidden">
      ...
      {/* ── GRATUIT / OPEN SOURCE ── (ancres #pricing et #soutenir conservées pour les anciens liens) */}
      ...
      <section id="soutenir" className="py-24 px-6 bg-stone-800 border-y border-stone-700">
        <div className="max-w-3xl mx-auto text-center reveal">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-stone-100">Gratuit. Open source. Pour toujours.</h2>
          <p className="text-stone-400 text-lg mb-10">
            Toutes les fonctionnalités, sans limite, sans compte, sans abonnement. Licence Apache-2.0.
          </p>
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm mb-12 text-left max-w-xl mx-auto">
            {[
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="/telechargement"
              className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:opacity-90 px-8 py-3.5 rounded-xl text-sm font-semibold transition-all text-white shadow-lg shadow-blue-900/40"
            >
              Télécharger Kyber
            </a>
            <a
              ...
              target="_blank"
              rel="noopener"
              className="border border-stone-700 hover:border-stone-500 px-8 py-3.5 rounded-xl text-sm font-semibold transition-all text-stone-300"
            >
