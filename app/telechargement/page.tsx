        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <section className="mb-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Windows */}
              <div className="bg-white border border-blue-200 rounded-2xl p-6 hover:border-blue-400 hover:shadow-md transition-all shadow-sm">
                <div className="mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-stone-300 rounded-2xl p-6 shadow-sm">
                ...
                <ol className="space-y-3 text-sm text-stone-700">
                  ...
                  <li className="flex gap-3">
                    <span className="text-blue-600 font-mono flex-shrink-0">4.</span>
