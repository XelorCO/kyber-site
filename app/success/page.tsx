export default function SuccessPage() {
  return (
    <div className="min-h-screen bg-[#f4f2ef] text-stone-900 flex items-center justify-center px-6">
        ...
        <div className="bg-white border border-stone-300 rounded-2xl p-6 text-left mb-8 shadow-sm">
          ...
          <ol className="space-y-3 text-stone-500 text-sm">
            <li className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">1</span>
              <span>Ouvrez l&apos;application <strong className="text-stone-900">Kyber</strong> sur votre ordinateur</span>
            </li>
            <li className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">2</span>
              <span>Dans la barre latérale gauche, cliquez sur <strong className="text-stone-900">Paramètres</strong></span>
            </li>
            <li className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">3</span>
              <span>Faites défiler jusqu&apos;à la section <strong className="text-stone-900">Licence Kyber</strong></span>
            </li>
            <li className="flex gap-3">
              <span className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs flex items-center justify-center flex-shrink-0 mt-0.5">4</span>
