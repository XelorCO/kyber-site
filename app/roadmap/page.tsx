...
const sections: { title: string; features: Feature[] }[] = [
  {
    ...
    features: [
      ...
      { title: 'Linux (x64)', desc: 'AppImage + .deb + .rpm. Testé Debian, Ubuntu, Kali, Fedora.', status: 'done' },
    ...
    <div className="min-h-screen bg-[#faf8f6] text-stone-900 overflow-x-hidden">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-3xl mx-auto px-6">
          ...
          {/* ── VOTE / SUGGESTION ── */}
          <section className="mt-16 bg-gradient-to-br from-blue-50 to-rose-50 border border-blue-200 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <a
                ...
                className="inline-block bg-gradient-to-r from-blue-500 via-rose-400 to-amber-400 hover:opacity-90 px-6 py-3 rounded-xl font-semibold transition-all text-sm text-white shadow-md"
              >
