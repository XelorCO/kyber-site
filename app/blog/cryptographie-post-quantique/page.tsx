        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="py-12">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-stone-400 text-xs">10 min de lecture</span>
            </div>
            ...
            <div className="space-y-8 text-stone-300 leading-relaxed">
              ...
              <section>
                ...
                <p>
                  ...
                  est le pilier de <strong className="text-stone-100">RSA</strong>. Le logarithme discret sur les
                  courbes elliptiques est la base de <strong className="text-stone-100">ECDSA</strong> et
                  <strong className="text-stone-100"> ECDH</strong>.
                </p>
                <p className="mt-4">
                ...
                <div className="mt-6 bg-amber-950/50 border border-amber-800 rounded-xl p-5">
              ...
              <section>
                ...
                <p>
                  ...
                  pouvait factoriser des grands nombres en <strong className="text-stone-100">temps polynomial</strong> /
                ...
                <ul className="mt-4 space-y-3">
                  {[
                    ...
                    <li key={titre} className="flex gap-3 items-start">
                      ...
                      <span><strong className="text-stone-100">{titre}</strong> : {desc}</span>
                    </li>
                  ))}
                </ul>
                <p className="mt-4">
                  En pratique : factoriser RSA-2048 nécessiterait environ <strong className="text-stone-100">4 000 qubits
              ...
              <section>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-amber-950/50 border border-amber-800 rounded-xl p-5">
                    <h3 className="font-semibold text-amber-300 mb-2">Affaibli par Grover (symétrique)</h3>
                ...
                <div className="mt-6 space-y-4">
                  {[
                    ...
                    <div key={name} className={`bg-${color}-50 border border-${color}-200 rounded-xl p-5`}>
                      ...
                      <p className="text-sm text-stone-400">Base mathématique : {base}</p>
                    </div>
                  ))}
                </div>
              </section>
              ...
              <section>
                ...
                <p>
                  ...
                  <strong className="text-stone-100"> Module Learning With Errors (M-LWE)</strong>. Sans entrer dans
                  les détails mathématiques, l&apos;idée est la suivante :
                </p>
                <div className="mt-6 bg-stone-900 border border-stone-700 rounded-xl p-6">
                  <p className="text-sm font-mono text-stone-300 mb-3">
                    Étant donné un système d&apos;équations linéaires <span className="text-blue-300">A·s + e = b</span>
                    <br />où <span className="text-indigo-400">s</span> est le secret et{' '}
                    <span className="text-amber-600">e</span> est un vecteur de petit bruit aléatoire...
                  </p>
                  <p className="text-sm text-stone-400">
                    Retrouver <span className="text-indigo-400 font-mono">s</span> est calculatoirement infaisable,
              ...
              <section>
                ...
                <p className="mt-6">
                  La raison pour laquelle il faut agir <strong className="text-stone-100">maintenant</strong> et pas en
                ...
                <div className="mt-6 bg-stone-900 border border-stone-700 rounded-xl p-6 space-y-3">
                  {[
                    ...
                    <div key={step} className="flex flex-col gap-0.5">
                      ...
                      <span className="text-xs text-stone-500 pl-4">{detail}</span>
                    </div>
                  ))}
                </div>
                <p className="mt-4">
              ...
              <section>
                <div className="bg-blue-950/50 border border-blue-800 rounded-xl p-6">
                  <h2 className="text-xl font-bold text-stone-100 mb-3">En résumé</h2>
