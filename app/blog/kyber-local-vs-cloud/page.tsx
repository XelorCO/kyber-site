    ...
    <div className="min-h-screen bg-[#faf8f6] text-stone-900 overflow-x-hidden">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-6">
          ...
          {/* ── EN-TÊTE ARTICLE ── */}
          <div className="py-12">
            <Link href="/blog" className="text-stone-400 hover:text-stone-700 text-sm transition-colors mb-8 inline-block">
              ← Blog
            </Link>
            <div className="flex items-center gap-3 mb-6">
              <span className="text-xs font-medium px-3 py-1 rounded-full border text-blue-700 bg-blue-50 border-blue-200">
                Analyse
              </span>
              <span className="text-stone-400 text-xs">8 juin 2026</span>
              <span className="text-stone-300 text-xs">·</span>
              <span className="text-stone-400 text-xs">8 min de lecture</span>
            </div>
            <h1 className="text-3xl md:text-4xl font-bold mb-4 leading-tight text-stone-900">
          ...
          <article className="prose prose-stone max-w-none">
            ...
            <div className="space-y-8 text-stone-600 leading-relaxed">
              ...
              <section>
                ...
                <p className="mt-4">
                  Mais votre coffre reste <strong className="text-stone-900">stocké sur leurs serveurs</strong>.
                </p>
              </section>
              ...
              <section>
                ...
                <ol className="mt-4 space-y-3 list-none pl-0">
                  {[
                    ...
                    <li key={i} className="flex gap-3 items-start">
                      <span className="text-blue-600 font-mono text-sm flex-shrink-0 mt-0.5">{i + 1}.</span>
                      <span>{item}</span>
                    </li>
                  ))}
                </ol>
                <p className="mt-4">
                  ...
                  le scénario où un attaquant <strong className="text-stone-900">vole directement la base de données
              ...
              <section>
                ...
                <p>
                  Avec Kyber (l&apos;application), votre coffre existe <strong className="text-stone-900">uniquement
                ...
                <p className="mt-4">
                  <strong className="text-stone-900">Un ordinateur quantique ne peut pas attaquer ce qu&apos;il ne peut
              ...
              <section>
                ...
                <p className="mt-4">
                  Ce fichier <code className="bg-stone-200 px-1.5 py-0.5 rounded text-sm">.vault</code> est
                  ...
                  <table className="w-full text-sm border-collapse">
                    ...
                    <tbody className="divide-y divide-stone-100">
                      {[
                        ...
                        <tr key={critere}>
                          <td className="py-2.5 pr-4 text-stone-500">{critere}</td>
                          <td className="py-2.5 px-4 text-center text-stone-500">{cloud}</td>
                          <td className="py-2.5 px-4 text-center text-green-600 font-medium bg-blue-50/50">{local}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
          ...
          <div className="mt-12 pt-8 border-t border-stone-300">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link
                ...
                className="border border-stone-300 hover:border-stone-400 bg-white hover:bg-stone-50 text-stone-700 px-6 py-3 rounded-xl font-semibold transition-all text-sm"
              >
