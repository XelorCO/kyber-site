...
export default function NavFooter() {
  return (
    <footer className="border-t border-stone-700 py-12 px-6 mt-12 bg-stone-800">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6 text-sm text-stone-400">
        <div className="flex flex-col items-center md:items-start gap-1">
          <span>
            <span className="font-bold text-stone-100">Kyber</span> / © 2026 Kyber Security. Made in France
          </span>
          <span>
            Créé avec soin par{' '}
            <a
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link href="/blog" className="hover:text-stone-100 transition-colors">Blog</Link>
          ...
          <Link href="/politique-de-confidentialite" className="hover:text-stone-100 transition-colors">Confidentialité</Link>
          <Link href="/cgv" className="hover:text-stone-100 transition-colors">CGV</Link>
          <a href="mailto:contact@kyber-security.fr" className="hover:text-stone-100 transition-colors">
