    ...
    <form onSubmit={handleSubmit} className="mt-3 space-y-2">
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 text-xs bg-stone-50 border border-stone-300 rounded-lg px-3 py-2 focus:outline-none focus:border-blue-400 text-stone-800 placeholder:text-stone-400"
        />
        <button
          type="submit"
          disabled={status === 'loading'}
          className="text-xs bg-stone-800 hover:bg-stone-700 disabled:opacity-50 text-white px-3 py-2 rounded-lg transition-colors whitespace-nowrap"
        >
